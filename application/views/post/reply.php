...
<form name="replayForm" method="post" action="<?php echo $this->getActionUrl('ajax_reply'); ?>" id="relypost_form">
  <tbody>
    ...
    <tr>
      ...
      <td align="left"><?php if($postInfo['reply_content']) { echo '[ 回复时间: ', $postInfo['reply_time'], ' ]<br>'; } ?><textarea name="content" id="content"><?php echo $postInfo['reply_content']; ?></textarea></td>
    </tr>
    <tr>
      <td height="30">&nbsp;</td>
...
<script type="text/javascript">$(document).ready(function(){$('#relypost_form').ajaxForm({beforeSubmit:replypostRequest,success:showResponse,dataType:'json'});});</script>